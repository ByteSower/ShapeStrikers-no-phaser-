...
const ELEMENT_SYNERGIES = [
  ...
  { element: 'blood',     requiredCount: 2, bonus: { stat: 'attack',  multiplier: 1.15 }, description: '2🩸: +15% ATK' },
  { element: 'blood',     requiredCount: 3, bonus: { stat: 'attack',  multiplier: 1.25 }, description: '3🩸: +25% ATK' },
  { element: 'plague',    requiredCount: 2, bonus: { stat: 'attack',  multiplier: 1.10 }, description: '2☠️: +10% ATK' },
  { element: 'plague',    requiredCount: 3, bonus: { stat: 'attack',  multiplier: 1.20 }, description: '3☠️: +20% ATK' },
];
